...
public class AñadirProf {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
		    ...
		    String sql2 ="INSERT INTO `profesores`(`CodigodeProfesor`, `Nombre`, `Apellidos`, `Direccion`, `Poblacion`, `Codigo Postal`, `Provincia`, `Telefono`, `Fecha de nacimiento`, `DNI`)"
		    		+ " VALUES ('7','Pedro','Sanchez','Palacio de la Moncloa Av.de Puerta de hiero s/n','Madrid','28071','Madrid','913353535','1972-02-29','01181099A')";
